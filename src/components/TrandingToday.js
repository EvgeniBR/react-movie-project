    ...
    useEffect(() => {
        ...
        const searchMovies = async () => {
          const data = await axios.get(
            `https://api.themoviedb.org/3/trending/movie/day?api_key=cb2ac8f2c2a5c42ec3b900e7b6d2e67b`
          );
...
export default withRouter(TrandingToday);
